<?php
    ...
    class Session
    {
        ...
        public function __construct()
        {
            ...
            $this -> secureCookie = !(SystemData::is_development() === true);
        ...
        public function destroy()
        {
            ...
            setcookie($this -> cookieName_CI, '', time() - 60*60*24, '/', Helper::domain(), $this -> secureCookie, true);
            setcookie($this -> cookieUser_CI, '', time() - 60*60*24, '/', Helper::domain(), $this -> secureCookie, true);

            unset($_COOKIE[$this -> cookieName_CI]);
            unset($_COOKIE[$this -> cookieUser_CI]);
