...
<section class="py-5" style="background:#f4f6f9;">
    <div class="container">
        ...
        <p class="mb-4" style="padding-left:21px; color:#666; font-size:1rem; font-weight:400;">
            Capacítate con los mejores profesionales y alcanza el siguiente nivel en tu carrera.
        </p>
        ...
        <div class="row g-4">
                ...
                <div class="card border-0 shadow-sm h-100 position-relative" style="border-radius:14px; overflow:hidden; transition: transform .25s, box-shadow .25s;"
                    ...
                    <div style="height:250px; overflow:hidden; position:relative; background:#dde0e6;">
                        ...
                        <div style="position:absolute; bottom:14px; left:14px; background:#005fff; color:#fff;
                            ...
                            <span style="font-size:26px; font-weight:900; display:block; letter-spacing:-0.5px;">S/ <?= (!isset($value['lanzamiento_costo'])) ? '-.--' : $value['lanzamiento_costo'] ?></span>
                        </div>
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <div class="d-grid mt-3">
                            <a href="<?= $base_url ?>/cursos/ver/<?= $value['curso_id'] ?>" class="btn btn-dark fw-700 position-relative z-3" style="border-radius:10px; letter-spacing:.6px; font-size:16px; padding:14px 20px;">
            ...
            <?php } if ($cursos == []) { ?>
                <div class="col-12 text-center py-5 text-muted fs-5">No hay cursos que mostrar. Muy pronto estarán disponibles.</div>
            <?php } ?>
