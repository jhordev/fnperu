<?php
    $heroBanners = (!empty($banners)) ? $banners : [
        ['banner_imagen' => null, '_static' => $assets_url . '/admin/images/general/curso_banner_1.png'],
        ['banner_imagen' => null, '_static' => $assets_url . '/admin/images/general/curso_banner_2.png'],
    ];
?>
<!-- ===== Mini Hero Section ===== -->
